...
def write():
    ...
    st.markdown("<h1 style='text-align: center; color: white;'>Friends</h1>", unsafe_allow_html=True)
    ...
    keys = {
    'Friends': './data/friends/friends.csv',
    'Received Friend Requests': './data/friends/received_friend_requests.csv',
    'Rejected Friend Requests': './data/friends/rejected_friend_requests.csv',
    'Removed Friends': './data/friends/removed_friends.csv',    
    'Sent Friend Requests': './data/friends/sent_friend_requests.csv',    
